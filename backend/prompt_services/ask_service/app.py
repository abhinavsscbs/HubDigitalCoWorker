...
def create_app(test_config=None):
    ...
    app.config["LOGGER"] = get_json_logger("ask-service")
    ...
    @require_basic_auth("Ask Service")
    def ask():
        ...
        try:
            ...
            data = require_non_empty_string_fields(payload, ["userId", "promptRequestText"])
            user_id = data["userId"]
            prompt_text = data["promptRequestText"]
            ...
            def answer_engine():
                ...
                engine_output = app.config["ANSWER_ENGINE_FUNC"](prompt_text)
                ...
                record = {
                    ...
                    "promptResponseText": engine_output["promptResponseText"],
                    "promptResponseTabularData": engine_output["promptResponseTabularData"],
                    "created_at": now_iso,
                    "updated_at": now_iso,
                }
                app.config["PROMPT_HISTORY_STORE"].add_prompt_record(user_id, record)
